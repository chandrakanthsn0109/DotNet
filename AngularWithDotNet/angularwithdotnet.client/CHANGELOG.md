...
- Create Angular project with ng: `ng new angularwithdotnet.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularwithdotnet.client.esproj`).
